...
CREATE TABLE memory_entries (
    ...
    summary         TEXT            NOT NULL COMMENT '记忆摘要 (应用层软上限 10KB)',
...
│  │  title       │       │ _id          │       │  summary           │  │
│  │  model_name  │       │  role        │       │  qdrant_point_id ──│──│──→ Qdrant memory_vectors
│  │  message_    │       │  content     │       └────────────────────┘  │
│  │  count       │       │  tool_calls  │                               │
│  └──────────────┘       └──────────────┘       ┌────────────────────┐  │
│                                                │  knowledge_         │  │
│  ┌──────────────┐       ┌──────────────┐       │  documents          │  │
│  │   intents     │◄──────│ intent_usage │       │                    │  │
│  │              │  1:N  │              │       │  id                │  │
│  │  id          │───────│  intent_id   │       │  filename          │  │
│  │  name        │       │  hit_count   │       │  file_type         │  │
│  │  target_     │       │  avg_        │       │  chunk_count       │  │
│  │  module      │       │  confidence  │       └────────┬───────────┘  │
│  │  qdrant_     │       └──────────────┘                │ 1:N          │
...
│  │    skills     │◄──────│ skill_stats  │      │  chunk_index       │  │
│  │              │  1:N  │              │      │  qdrant_point_id ──│──│──→ Qdrant knowledge_chunks
│  │  id          │───────│  skill_id    │      └────────────────────┘  │
│  │  name        │       │  call_count  │                               │
│  │  enabled     │       │  success_    │      ┌────────────────────┐  │
│  └──────────────┘       │  count       │      │     schedules       │  │
...
│  │   workflows   │       └──────────────┘      │  title             │  │
│  │              │                              │  start_time        │  │
│  │  id          │  1:N  ┌──────────────┐      │  reminder_minutes  │  │
│  │  name        │───────│ workflow_    │      │  reminded          │  │
│  │  dag_json    │       │ runs         │      └────────────────────┘  │
│  │  trigger_    │       │              │                               │
│  │  type        │       │  workflow_id │      ┌────────────────────┐  │
│  └──────────────┘       │  status      │      │  clipboard_items    │  │
│                         │  started_at  │      │                    │  │
│                         │  finished_at │      │  id                │  │
│                         └──────┬───────┘      │  content           │  │
│                                │ 1:N          │  content_type      │  │
...
│  │    tools      │◄──────│ tool_stats   │                               │
│  │              │  1:N  │              │      ┌────────────────────┐  │
│  │  id          │───────│  tool_id     │      │  pet_attributes     │  │
│  │  name        │       │  call_count  │      │                    │  │
│  │  json_schema │       │  avg_        │      │  id                │  │
│  └──────────────┘       │  duration_ms │      │  hunger/clean/mood │  │
│                         └──────────────┘      │  health/intimacy/  │  │
│                                               │  level/exp         │  │
│  ┌──────────────┐       ┌──────────────┐      │  last_active_at    │  │
...
│  │              │  1:N  │              │                               │
│  │  id          │───────│  command_id  │      ┌────────────────────┐  │
│  │  name        │       │  use_count   │      │  pet_interactions   │  │
│  │  shortcut_   │       │  last_used   │      │                    │  │
│  │  key         │       └──────────────┘      │  id                │  │
│  └──────────────┘                              │  interaction_type  │  │
│                                               │  effect_json       │  │
...
│  │   settings    │                                                       │
│  │              │      ┌──────────────┐      ┌────────────────────┐  │
│  │  key (UK)    │      │ action_logs  │      │  ai_feedback        │  │
│  │  value       │      │              │      │                    │  │
│  │  restart_    │      │  module      │      │  conversation_id ──│──→ conversations
│  │  required    │      │  action      │      │  feedback_type     │  │
│  └──────────────┘      │  params_     │      │  trace_id          │  │
│                         │  summary     │      └────────────────────┘  │
│  ┌──────────────┐      └──────────────┘                               │
│  │ soul_configs  │                                                      │
│  │              │      ┌──────────────┐      ┌────────────────────┐  │
│  │  name        │      │performance_  │      │  prompts            │  │
│  │  personality │      │ metrics      │      │                    │  │
│  │  system_     │      │              │      │  name              │  │
│  │  prompt      │      │  cpu_percent │      │  version           │  │
│  │  is_active   │      │  memory_     │      │  is_active         │  │
│  └──────────────┘      │  percent     │      └────────────────────┘  │
│                         │  disk_       │                               │
│  ┌──────────────┐      │  percent     │                               │
│  │backup_records │      └──────────────┘                               │
...
| action_logs | (created_at, module) | 联合 | 按时间+模块查行为日志 |
