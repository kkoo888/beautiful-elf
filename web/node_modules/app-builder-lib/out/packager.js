...
class Packager {
    ...
    getNodeDependencyInfo(platform, flatten = true) {
        ...
        if (result == null) {
            result = (0, packageDependencies_1.createLazyProductionDeps)(this.appDir, excludedDependencies, flatten);
    ...
    async validateConfig() {
        ...
        this._originalMetadata = (0, builder_util_1.deepAssign)({}, this._metadata);
        (0, builder_util_1.deepAssign)(this._metadata, configuration.extraMetadata);
