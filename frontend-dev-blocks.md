...
**主窗口内的宠物属性展示，不含 3D 渲染**

### 包含内容

| Tab | 内容 |
|-----|------|
| 状态 Tab | 六维属性 Progress + 状态文字 + 模型信息 |
| 互动 Tab | 喂食/清洁/聊天按钮 + 互动记录列表 |
| 设置 Tab | 模型路径/窗口配置/衰减速度/气泡频率 + 打开宠物窗口按钮 |
...
pet/
├── PetPanel.tsx           # 主面板
├── PetStatus.tsx          # 六维属性展示
├── PetInteraction.tsx     # 互动操作
├── PetHistory.tsx         # 互动记录
