...
class Intent(BaseModel):
    ...
    tool_names = Column(JSON, nullable=False, default=list, comment="关联工具列表: []=无工具, ['web_search']=指定工具")
    metadata_ = Column("metadata", JSON, nullable=False, default=dict, comment="扩展元数据")
...
class IntentUsage(BaseModel):
    ...
    last_hit_at = Column(DateTime, nullable=False, default=datetime(2000, 1, 1), comment="最后命中时间")
