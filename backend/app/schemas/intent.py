...
class IntentCreate(CamelModel):
    ...
    tool_names: Optional[List[str]] = Field(default=None, alias="toolNames", description="关联工具列表: null=全量, []=无工具")
...
class IntentUpdate(CamelModel):
    ...
    tool_names: Optional[List[str]] = Field(default=None, alias="toolNames", description="关联工具列表")
    metadata: Optional[dict] = Field(default=None, description="扩展元数据")
